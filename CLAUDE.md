...
> Last updated: July 1, 2026 (evening — Fix 1B production cutover complete: retention_floor + chapter-spanning caveat wired through lifecycle + canonical_v1 + canonical_v2. All 3 stages Fix 1B, orchestrator unchanged. Retention_days=NULL for all 4 clients so semantics collapse to Fix 2 identically; first tenant with retention set will exercise the frozen-chapter path.)
