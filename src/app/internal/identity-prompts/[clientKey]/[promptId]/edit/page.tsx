...
export default async function EditPromptPage({
  ...
  const { data: prompt } = await supabase
    ...
    .select(
      "id, slug, trigger_jsonb, headline, body, input_mode, email_placeholder, phone_placeholder, button_label, success_message, offer_code, offer_description, post_submit_action, post_submit_url, post_submit_button_label, frequency, frequency_days, enabled",
    )
    .eq("id", promptId)
