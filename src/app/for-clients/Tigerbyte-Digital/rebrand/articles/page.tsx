          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-[75ch] text-base md:text-lg text-neutral-700 leading-relaxed">
                Educational resources for publishers, content creators, and media
                brands looking to understand website monetization, ad revenue
                optimization, ad operations, and traffic growth.
              </p>
