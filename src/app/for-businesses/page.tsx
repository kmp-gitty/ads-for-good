      ...
      <section className="w-full bg-orange-50">
        <Link href="/for-businesses/ask-us-anything" className="block">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 py-16 
            ...
            {/* Image */}
            <div className="flex-1 rounded-3xl border border-orange-200 bg-white shadow-sm min-h-[220px] overflow-hidden h-40">
              <img
      ...
      <section className="w-full bg-white">
        <Link href="/for-businesses/consulting" className="block">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 py-16 
            ...
            {/* Image */}
            <div className="flex-1 rounded-3xl border border-neutral-900 bg-white shadow-sm min-h-[220px] overflow-hidden h-40">
              <img
